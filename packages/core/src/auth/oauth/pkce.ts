...
/**
 * `state` (chống CSRF) và PKCE `code_verifier`/`code_challenge` (chống đánh cắp
 * authorization code) cho luồng OAuth 2.0 Authorization Code.
 *
 ...
 * sống trong cookie vài phút — nên không cần các hàm băm đi kèm ở đó.
 */
